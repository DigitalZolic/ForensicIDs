...
Features:
  - BIOS Identification
  - S-BOOT Identification
  - SYS Identification
  - TPM + EK Identification
  - CPU Identification
  - RAM Identification
  - DISK Identification
...
Notes:
  ...
  How to execute utility?
  - Open Powershell as Administrator
  - Execute this command: Set-ExecutionPolicy unrestricted
  - Run script with powershell (Do not use Powershell ISE)
