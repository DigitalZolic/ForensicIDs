...
function Collect-MotherboardCategory {
    ...
    Collect-Info "Motherboard Part Number"  { $CIM.BaseBoard.PartNumber }
...
function Collect-ProcessorCategory {
    ...
    Collect-Info "Processor ID"            { $CIM.Processor.ProcessorId }
}
...
Motherboard Part Number: $($hardwareDetails['Motherboard Part Number'])
...
Processor Asset Number: $($hardwareDetails['Processor Asset Tag'])
Processor ID: $($hardwareDetails['Processor ID'])
